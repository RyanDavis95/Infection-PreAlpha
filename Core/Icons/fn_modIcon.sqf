...
switch (_type) do {
    case "ENGAGED": {
        ...
        _color1 = [1,1,0,1]; 
        _color2 = [0,1,1,1];
        _client setVariable ["INF_Icons_Texture",INF_Settings_MissionRoot +"resources\images\icons\triangle_ca.paa",true];
        };
    case "NORMAL": {
        
            if (_team == "SURVIVOR") then {
                _color1 = [0,1,1,1];
                _client setVariable ["INF_Icons_Texture",INF_Settings_MissionRoot +"resources\images\icons\shield_ca.paa",true];
            };          
